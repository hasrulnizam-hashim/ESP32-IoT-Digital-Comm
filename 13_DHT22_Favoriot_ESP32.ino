...
#define APIKEY  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ikhhc3J1bG5pemFtIiwicmVhZF93cml0ZSI6dHJ1ZSwiaWF0IjoxNTcxOTcxNTE5fQ.QidLy4-RVDq-zirjI1HLRERpfjh-JFEPZUwYBDgD5PE"
#define DEVICE_DEV_ID "TempHumid@Hasrulnizam"

const int SEN_PIN = 19;
SimpleDHT22 dht22(SEN_PIN);

const char ssid[] = "ijamSiti2G@unifi";
const char password[] = "0123012469";
